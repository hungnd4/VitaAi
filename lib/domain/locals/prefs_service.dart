...
class PrefsService {
  ...
  static const _PREF_REFRESH_TOKEN_KEY = 'pref_refresh_token_key';
  ...
  static Future<bool> saveRefreshToken(String value) async {
    final prefs = await _instance;
    return prefs.setString(_PREF_REFRESH_TOKEN_KEY, value);
  }

  static String getRefreshToken() {
    return _prefsInstance?.getString(_PREF_REFRESH_TOKEN_KEY) ?? '';
  }
