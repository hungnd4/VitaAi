...
extension StringValidate on String {
  String? checkRequired(String? fieldName) {
  ...
  String? isNormalCharacter({required String errorMessage}) {
    if (!RegExp(RegexConstants.CHARACTER_REGEX).hasMatch(this)) {
      return errorMessage;
    }
    return null;
  }
  ...
  String? validatePassword() {
    if (!RegExp(RegexConstants.PASSWORD_REGEX_2).hasMatch(this)) {
...
extension FormatDateTimeExt on String {
